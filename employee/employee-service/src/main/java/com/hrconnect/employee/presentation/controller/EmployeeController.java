...
import com.hrconnect.employee.application.dto.ResultatRepublishDTO;
...
public class EmployeeController {
  ...
  @RolesAllowed({"ADMIN"})
  public ResponseEntity<ResultatRepublishDTO> republish() {
    int employeeCount = employeeService.republish();
    ResultatRepublishDTO dto = new ResultatRepublishDTO(
      "Republication déclenchée",
      employeeCount,
      "",
      null
    );
