...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, EmployeeState> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, EmployeeState.class.getName());
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EmployeeState> kafkaListenerContainerFactory() {
